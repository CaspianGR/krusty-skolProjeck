...
public class Database {
	...
	/**
	 * Connects to the database, uses HSQLDB.
	 */
	public void connect() {
		try {
	...
	/**
	 * Gets all data on customers in the database.
	 *
	 * @param req HTTP Request via Spark API.
	 * @param res HTTP Response via Spark API.
	 * @return JSON representation of customers in the database.
	 */
	...
	/**
	 * Gets all data on raw materials currently stocked in the database.
	 *
	 * @param req HTTP Request via Spark API.
	 * @param res HTTP Response via Spark API.
	 * @return JSON representation of recipes in the database.
	 */
	...
	/**
	 * Gets all data on cookies in the database.
	 *
	 * @param req HTTP Request via Spark API.
	 * @param res HTTP Response via Spark API.
	 * @return JSON representation of recipes in the database.
	...
	/**
	 * Gets all data on recipes in the database.
	 *
	 * @param req HTTP Request via Spark API.
	 * @param res HTTP Response via Spark API.
	 * @return JSON representation of recipes in the database.
	...
	/**
	 * Gets pallets from the database corresponding to different filters given by HTTP request.
	 *
	 * @param req HTTP Request via Spark API.
	 * @param res HTTP Response via Spark API.
	 * @return JSON representation of found pallets corresponding to given filters.
	 */
	...
	/**
	 * Tries to reset the database to an original state.
	 *
	 * @param req HTTP Request via Spark API.
	 * @param res HTTP Response via Spark API.
	 * @return <code>{"status": "ok"}</code> if reset was successful.
	 */
	...
	/**
	 * Tries to create a pallet containing a certain cookie which is specified via an incoming HTTP request.
	 *
	 * @param req HTTP Request via Spark API.
	 * @param res HTTP Response via Spark API.
	 * @return <code>{"status": "unknown cookie"}</code> if the cookie from the request isn't in the database. <br>
	 * <code>{"status": "error"}</code> if other errors occur. <br>
	 * <code>{"status": "ok", "id": *id*}</code> if pallet creation was successful; <code>*id*</code> represents
	 * the integer key generated when the pallet was created.
	 */
